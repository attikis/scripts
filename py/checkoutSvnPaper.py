...
EXAMPLES:
./checkoutSvnPaper.py -n HIG-18-014 --noteType papers
./checkoutSvnPaper.py -n HIG-18-015 --noteType papers
./checkoutSvnPaper.py -n DN-14-002 --noteType notes
...
parser.add_option("-d", "--dirname" , default = "SvnPapers" , dest = "dirname" , help = "DIR NAME TO CHECKOUT NOTE", metavar = "DIR NAME TO CHECKOUT NOTE")
...
if __name__ == "__main__":
    ...
    # For-loop: All shell commands to be executed
    print "\n=== checkoutSvnPaper.py (Please copy-paste the following commands):"
